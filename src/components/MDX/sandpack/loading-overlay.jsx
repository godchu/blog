...
import { OpenInCodeSandboxButton, useSandpack } from '@codesandbox/sandpack-react/unstyled';

const FADE_ANIMATION_DURATION = 200;

export const LoadingOverlay = ({ clientId, dependenciesLoading, forceLoading }) => {
    ...
    return (
      <div className="sp-overlay sp-error">
        <div className="sp-error-message">
          Unable to establish connection with the sandpack bundler. Make sure you are online or try again later. If the
          problem persists, please report it via{' '}
          <a className="sp-error-message" href="mailto:hello@codesandbox.io?subject=Sandpack Timeout Error">
            email
          </a>{' '}
...
const useLoadingOverlayState = (clientId, dependenciesLoading, forceLoading) => {
