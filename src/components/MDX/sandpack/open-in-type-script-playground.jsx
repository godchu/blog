...
export const OpenInTypeScriptPlaygroundButton = (props) => {
  ...
  return (
    <a
      ...
      href={`https://www.typescriptlang.org/play#src=${encodeURIComponent(contentWithReactImport)}`}
      title="Open in TypeScript Playground"
      target="_blank"
      rel="noreferrer"
    >
      <IconNewPage className="inline mx-1 relative top-[1px]" width="1em" height="1em" />
