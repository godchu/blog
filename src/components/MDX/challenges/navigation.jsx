...
export function Navigation({ challenges, handleChange, currentChallenge, isRecipes }) {
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="overflow-hidden">
        <div ref={containerRef} className="flex relative transition-transform content-box overflow-x-auto">
      ...
      <div className="flex z-10 pb-2 ps-2">
        ...
        <button
          ...
          className={cn('bg-secondary-button dark:bg-secondary-button-dark h-8 px-2 rounded-e rtl:rotate-180', {
