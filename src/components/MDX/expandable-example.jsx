...
import { IconCodeBlock } from '../icon/icon-code-block';
import { IconDeepDive } from '../icon/icon-deep-dive';

import { H4 } from './heading';

function ExpandableExample({ children, excerpt, type }) {
  if (!Array.isArray(children) || children[0].type.mdxName !== 'h4') {
    throw Error(`Expandable content ${type} is missing a corresponding title at the beginning`);
  }
  ...
  return (
    <details
      ...
      className={cn('my-12 rounded-2xl shadow-inner-border dark:shadow-inner-border-dark relative', {
    ...
    >
      ...
      >
        ...
        <div className="mb-4">
          <H4 id={id} className="text-xl font-bold text-primary dark:text-primary-dark">
