...
//       className="block h-full w-full rounded-2xl outline-none focus:outline-none focus-visible:outline focus-visible:outline-link focus:outline-offset-2 focus-visible:dark:focus:outline-link-dark"
//     >
//       <div className="flex flex-col sm:flex-row lg:flex-row-reverse h-full w-full cursor-pointer rounded-2xl shadow-secondary-button-stroke dark:shadow-secondary-button-stroke-dark hover:bg-gray-40/5 active:bg-gray-40/10 hover:dark:bg-gray-60/5 active:dark:bg-gray-60/10">
//         {/* Image Section */}
//         {image && (
//           <div className="relative w-full sm:w-48 lg:w-56 h-48 sm:h-auto lg:h-auto rounded-t-2xl sm:rounded-l-2xl lg:rounded-l-none lg:rounded-r-2xl overflow-hidden flex-shrink-0">
//             <Image
//               src={image}
//               alt={title}
//               fill
...
//               {icon === 'labs' && (
//                 <svg className="w-6 h-6" viewBox="0 0 72 72" fill="none">
//                   <path fillRule="evenodd" clipRule="evenodd" d="M27.4865 9C25.8297 9..." fill="currentColor" />
//                 </svg>
//               )}
//               {icon === 'blog' && (
//                 <svg className="w-6 h-6" viewBox="0 0 72 72" fill="none">
