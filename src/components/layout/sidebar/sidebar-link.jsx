...
import { IconCanary } from '@/components/icon/icon-canary';
import { IconExperimental } from '@/components/icon/icon-experimental';
import { IconNavArrow } from '@/components/icon/icon-nav-arrow';
...
export function SidebarLink({
  ...
  return (
    <Link
      ...
      {isExpanded !== undefined && !hideArrow && (
        <span
          className={cn('pe-1', {
