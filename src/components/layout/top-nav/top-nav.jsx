...
import { IconHamburger } from '@/components/icon/icon-hamburger';
    ...
    <div className="flex flex-auto sm:flex-1">
      <Link
        ...
        className={cn(
          ...
          isActive && 'bg-highlight dark:bg-highlight-dark text-link dark:text-link-dark',
        )}
      >
        {children}
      </Link>
...
export default function TopNav({ routeTree, breadcrumbs, section }) {
          ...
          <div className="flex items-center justify-between w-full h-16 gap-0 sm:gap-3">
            ...
            <div className="text-base justify-center items-center gap-1.5 flex 3xl:flex-1 flex-row 3xl:justify-end">
              <div className="mx-2.5 gap-1.5 hidden lg:flex">
                ...
                <NavItem isActive={section === 'novel'} url="/docs/novel/to-haru">
                  Novel
                </NavItem>
