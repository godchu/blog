...
import { IconNewPage } from '@/components/icon/icon-new-page';
...
export default function BrandMenu({ children }) {
  return (
    <ContextMenu.Root>
      <ContextMenu.Trigger className="flex items-center">{children}</ContextMenu.Trigger>
      <ContextMenu.Portal>
        <ContextMenu.Content
        ...
        >
          ...
          <DownloadMenuItem fileName="react_logo_dark.svg" href="/images/brand/logo_dark.svg">
            <span className="w-8">
              <IconDownload />
            </span>
            <span>Logo SVG</span>
          </DownloadMenuItem>
          <DownloadMenuItem fileName="react_wordmark_dark.svg" href="/images/brand/wordmark_dark.svg">
            <span className="w-8">
              <IconDownload />
            </span>
          ...
          <DownloadMenuItem fileName="react_logo_light.svg" href="/images/brand/logo_light.svg">
            <span className="w-8">
              <IconDownload />
            </span>
            <span>Logo SVG</span>
          </DownloadMenuItem>
          <DownloadMenuItem fileName="react_wordmark_light.svg" href="/images/brand/wordmark_light.svg">
            <span className="w-8">
              <IconDownload />
            </span>
            <span>Wordmark SVG</span>
          ...
          <div className="uwu-visible flex flex-col">
            ...
            <ContextMenu.Label className="ps-4 text-base text-tertiary dark:text-tertiary-dark">uwu</ContextMenu.Label>
            <MenuItem
              onSelect={() => {
                // @ts-ignore
